...
function lessonCharge(l){const s=student(l.studentId);if(l.chargeStudent!=='yes')return 0;const rate=Number(s.rate)||0,duration=hours(l.start,l.end);return rate*duration}
